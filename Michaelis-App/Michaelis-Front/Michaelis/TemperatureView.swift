        ...
        ZStack{
            ...
            VStack(spacing: 16) {
                ...
                LineChartView3(
                    ...
                    heartRateLabels: [37.5, 37.2, 36.9, 36.6, 36.3, 36]
                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 10) {
                        RecommendationView(title: "体温记录", description: "最近体温异常记录，过低/过高，有按时吃药吗？", imageName: "temp1")
                        RecommendationView(title: "及时添衣", description: "天气转凉，记得及时增添衣物,不要感冒咯。", imageName: "temp2")
                        RecommendationView(title: "记得带伞", description: "近期会下雨，点击设置提醒自己带伞哦", imageName: "temp3")
                    }
                    .padding(.horizontal)
                }
                .padding(.bottom,10)
