...
struct RegisterView: View {
    ...
    func sendVerificationCode() {
        guard let url = URL(string: "https://9d08-101-126-56-41.ngrok-free.app/user/signup/code/send") else { return }
    ...
    func register() {
        guard let url = URL(string: "https://9d08-101-126-56-41.ngrok-free.app/user/signup") else { return }
