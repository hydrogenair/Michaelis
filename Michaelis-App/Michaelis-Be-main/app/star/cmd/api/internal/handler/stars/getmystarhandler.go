...
func GetMyStarHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MyStarsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := stars.NewGetMyStarLogic(r.Context(), svcCtx)
		resp, err := l.GetMyStar(&req)
